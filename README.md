...
| Метод | Эндпоинт                   | Описание                 | Статус | Минимальный доступ |
|-------|----------------------------|--------------------------|--------|--------------------|
| POST  | `/api/auth/login`          | Вход в систему           | ✅     | USER               |
| POST  | `/api/auth/register`       | Регистрация пользователя | ✅     | USER               |
| POST  | `/api/auth/register-admin` | Регистрация админа       | ✅     | ADMIN              |
...
| Метод | Эндпоинт                     | Описание                         | Минимальный доступ    | Статус |
|-------|------------------------------|----------------------------------|-----------------------|--------|
...
| PATCH | `/api/cards/{id}/block`      | Заблокировать карту              | USER(для своей карты) | ✅      |
| PATCH | `/api/cards/{id}/activate`   | Активировать карту               | USER(для своей карты) | ✅      |
...
{
  "cardNumber": "4111111111111111", или "4111 1111 1111 1111"
...
| GET   | `/api/transfers/card/{userId}` | Переводы по карте     | ADMIN  | ✅     |
...
- **Управление картами**: Создание, просмотр, удаление, блокировка
